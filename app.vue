...
<template>
  <div>
    <!-- Preloader -->
    <div v-if="isActiveLoader" class="preloader">
                ...
                <div class="row">
                  <div class="col-lg-7 col-12">
                    <div class="hero-text">
                      ...
                      <p>Maboriosam in a nesciung eget magnae <br> dapibus disting tloctio in the find it pereri <br>
                        odiy maboriosm.</p>
                      <div class="button">
                  ...
                  <div class="quantity">
                    ...
                    <div class="input-group">
                      <div class="button minus">
                        <button type="button" class="btn btn-primary btn-number" disabled data-type="minus"
                          data-field="quant[1]">
                          <i class="ti-minus"></i>
                        </button>
                      </div>
